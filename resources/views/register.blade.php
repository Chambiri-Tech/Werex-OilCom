...
<title>Register - Werex OilCom Management System</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" rel="stylesheet">
<style>
:root {
    --accent-color: #10B981; /* Teal for buttons/inputs */
    --panel-overlay-left: rgba(14,165,233,0.2); /* Partial blue overlay */
    --panel-overlay-right: rgba(245,158,11,0.2); /* Partial amber overlay */
}
...
<div class="login-wrapper">
    ...
    <div class="login-left">
        ...
        <p>Take control of our journey to success. Sign up today to easily manage your progress, track your performance, and stay on top of your progress.</p>

        <div class="features mt-4">
            <p><i class="fas fa-check-circle me-2"></i><strong>Simple & Intuitive</strong> — No prior experience needed, start immediately.</p>
            <p><i class="fas fa-shield-alt me-2"></i><strong>Safe & Secure</strong> — Your data is protected with top security standards.</p>
            <p><i class="fas fa-chart-line me-2"></i><strong>Track Your Progress</strong> — Keep an eye on your courses and grades at a glance.</p>
            <p><i class="fas fa-headset me-2"></i><strong>Support When You Need</strong> — Friendly support ready to help new users.</p>
        </div>
    </div>

        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm news-card h-100">
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <a href="#" class="btn btn-outline-primary mt-auto rounded-pill">Read More</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm news-card h-100">
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <a href="#" class="btn btn-outline-success mt-auto rounded-pill">Read More</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm news-card h-100">
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <a href="#" class="btn btn-outline-warning mt-auto rounded-pill">Read More</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm news-card h-100">
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <p class="card-text text-muted small mb-4">
                        Customers in our local delivery zones can now get free delivery for orders above 5 litres.
                    </p>
                    <a href="#" class="btn btn-outline-info mt-auto rounded-pill">Read More</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm news-card h-100">
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <p class="card-text text-muted small mb-4">
                        Education drive to help customers identify pure cooking oil and understand the importance of quality in meals.
                    </p>
                    <a href="#" class="btn btn-outline-danger mt-auto rounded-pill">Read More</a>
                </div>
            </div>
        </div>
    </div>
